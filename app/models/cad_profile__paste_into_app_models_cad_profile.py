...
class CadProfile(db.Model):
    ...
    # Quotation costing — supply rate per metre of this profile (NULL = fall back
    # to the tenant's material frame rate in pricing_rules)
    cost_per_metre   = db.Column(db.Numeric(10, 2), nullable=True)
    ...
    def to_dict(self) -> dict:
        return {
            ...
            'cost_per_metre': float(self.cost_per_metre) if self.cost_per_metre is not None else None,
